...
export declare class OpenSeaPort {
    ...
    createHashedOrder({ asset, accountAddress, startAmount, quantity, expirationTime, paymentTokenAddress, sellOrder, referrerAddress, }: {
        asset: Asset;
        accountAddress: string;
        startAmount: number;
        quantity?: number;
    ...
    createOrderWithSignature({ asset, accountAddress, startAmount, quantity, expirationTime, paymentTokenAddress, sellOrder, referrerAddress, }: {
        asset: Asset;
        accountAddress: string;
        startAmount: number;
        quantity?: number;
    ...
    authorizeMoonpadOrder(order: UnsignedOrder): Promise<any>;
    /**
    ...
    validateMoonpadSignature(signature: string): ECSignature;
    /**
