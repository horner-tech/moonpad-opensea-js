...
export declare function signMoonpadTypedDataAsync(signer: any, message: string, signerAddress: string): Promise<ECSignature>;
/**
...
export declare const parseMoonpadSignatureHex: (signature: string) => ECSignature;
/**
