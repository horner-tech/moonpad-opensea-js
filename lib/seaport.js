...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.authorizeOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var signerAddress, message_1, signerOrderNonce, orderForSigning, message, ecSignature, error_13;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        this._dispatch(types_1.EventType.TransactionFailed, __assign(__assign({}, transactionEventData), { error: error_14 }));
                        throw error_14;
                    case 7: return [2 /*return*/];
                }
            });
