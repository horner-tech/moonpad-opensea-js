...
var OpenSeaPort = /** @class */ (function () {
    ...
    // MOONPAD FUNCTIONS
    OpenSeaPort.prototype.createHashedOrder = function (_b) {
    ...
    OpenSeaPort.prototype.createOrderWithSignature = function (_b) {
        var asset = _b.asset, accountAddress = _b.accountAddress, startAmount = _b.startAmount, _c = _b.quantity, quantity = _c === void 0 ? 1 : _c, _d = _b.expirationTime, expirationTime = _d === void 0 ? 0 : _d, paymentTokenAddress = _b.paymentTokenAddress, sellOrder = _b.sellOrder, referrerAddress = _b.referrerAddress;
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaPort.prototype.authorizeMoonpadOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var signerAddress, EIP_712_ORDER_TYPES_CUSTOM, message_1, signerOrderNonce, orderForSigning, message, error_3;
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        message = JSON.stringify({
                            types: EIP_712_ORDER_TYPES_CUSTOM,
                            domain: {
                        ...
                        // We want to return just the message that we need to sign with the wallet on frontend
                        // With the signature we can then parseMoonpadSignatureHex and post to OS order book
    ...
    OpenSeaPort.prototype.createFactorySellOrders = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _makeAndPostOneSellOrder, range, batches, numOrdersCreated, _h, batches_1, subRange, batchOrdersCreated;
            var _this = this;
                ...
                switch (_j.label) {
                    case 0:
                        ...
                        _makeAndPostOneSellOrder = function (asset) { return __awaiter(_this, void 0, void 0, function () {
                            var order, hashedOrder, signature, error_6, orderWithSignature;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, this._makeSellOrder({
                                            asset: asset,
                        ...
                        _j.label = 1;
                    case 1:
                        if (!(_h < batches_1.length)) return [3 /*break*/, 5];
                    ...
                    case 4:
                        _h++;
                        return [3 /*break*/, 1];
                    case 5: return [2 /*return*/, numOrdersCreated];
                }
            });
        });
    };
    ...
    OpenSeaPort.prototype.createBundleSellOrder = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var order, hashedOrder, signature, error_7, orderWithSignature;
    ...
    OpenSeaPort.prototype.fulfillOrder = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var matchingOrder, _c, buy, sell, metadata, object;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
    ...
    OpenSeaPort.prototype.approveSemiOrNonFungibleToken = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, tokenContract, contract, approvalAllCheck, isApprovedForAll, txHash, error_8, approvalOneCheck, isApprovedForOne, txHash, error_9;
            var _this = this;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
    ...
    OpenSeaPort.prototype._estimateGasForMatch = function (_b, retries) {
        ...
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var value, wyvernProtocol, wyvernProtocolReadOnly, error_12;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
    ...
    OpenSeaPort.prototype._validateMatch = function (_b, retries) {
        ...
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var buyValid, sellValid, wyvernProtocol, wyvernProtocolReadOnly, canMatch, calldataCanMatch, error_13;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _e.trys.push([0, 7, , 10]);
    ...
    OpenSeaPort.prototype._atomicMatch = function (_b) {
        var buy = _b.buy, sell = _b.sell, accountAddress = _b.accountAddress, _c = _b.metadata, metadata = _c === void 0 ? constants_1.NULL_BLOCK_HASH : _c;
        return __awaiter(this, void 0, void 0, function () {
            var value, txnData, args, encoded;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!(buy.paymentToken == constants_1.NULL_ADDRESS)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._getRequiredAmountForTakingSellOrder(sell)];
                    case 1:
                        value = _d.sent();
                        _d.label = 2;
                    case 2:
                        ...
                        encoded = this._wyvernProtocolReadOnly.wyvernExchange.atomicMatch_.getABIEncodedTransactionData(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10]);
                        return [2 /*return*/, {
                                encoded: encoded,
                                txnData: txnData
                            }];
    ...
    OpenSeaPort.prototype.validateMoonpadSignature = function (signature) {
        return (0, utils_1.parseMoonpadSignatureHex)(signature);
    };
    /**
    ...
    OpenSeaPort.prototype.authorizeOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var signerAddress, message_2, signerOrderNonce, orderForSigning, message, ecSignature, error_15;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        signerAddress = order.maker;
                    ...
                    case 1:
                        ...
                        if (!(order.exchange ===
                            utils_1.wyvern2_2ConfigByNetwork[this._networkName]
                                .wyvernExchangeContractAddress &&
                            order.hash)) return [3 /*break*/, 3];
                        message_2 = order.hash;
                        return [4 /*yield*/, (0, utils_1.personalSignAsync)(this.web3, message_2, signerAddress)];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3: return [4 /*yield*/, this.getNonce(signerAddress)];
                    case 4:
                        signerOrderNonce = _b.sent();
